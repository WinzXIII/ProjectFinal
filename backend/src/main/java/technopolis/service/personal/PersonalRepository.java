...
public interface PersonalRepository extends JpaRepository<Personal, Integer> {
    ...
    @Query("SELECT new technopolis.service.ServiceUserPersonalDTO(u.id, u.username AS employeeId, CONCAT(p.gender, p.firstName, ' ', p.lastName) AS Name, p.position, p.department, p.agency, u.role, p.image, u.enable) "
            +
